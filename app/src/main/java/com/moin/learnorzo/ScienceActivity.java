...
public class ScienceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (ButtonChoice1.getText() == Answer){
                    ...
                    Toast.makeText(ScienceActivity.this, "wrong", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
            }
        });
        ...
        ButtonSkip.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                Toast.makeText(ScienceActivity.this, "skipping", Toast.LENGTH_SHORT).show();
                updateQuestion();
            }
        });
    ...
    private void updateQuestion(){
        if(QuestionNumber<5){
            QuestionView.setText(science.getQuestion(QuestionNumber));
            ButtonChoice1.setText(science.getChoice1(QuestionNumber));
            ButtonChoice2.setText(science.getChoice2(QuestionNumber));
            ButtonChoice3.setText(science.getChoice3(QuestionNumber));
            ButtonChoice4.setText(science.getChoice4(QuestionNumber));

            Answer = science.getCorrectAnswer(QuestionNumber);
            QuestionNumber++;
        }else {
            Intent intent = new Intent(ScienceActivity.this, ScoreActivity.class);
