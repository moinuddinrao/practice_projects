...
{
    partial class FormViewProjects
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.panel2.Size = new System.Drawing.Size(1133, 150);
			...
			// Column1
			// 
			this.Column1.DataPropertyName = "ProjectTitle";
			this.Column1.HeaderText = "Project Title";
			...
			// Column2
			// 
			this.Column2.DataPropertyName = "Members";
			...
			this.label7.Text = "Portflio Team©";
			// 
			// label8
			// 
			...
			this.panel8.Size = new System.Drawing.Size(1133, 35);
			...
			this.Name = "FormViewProjects";
			this.Text = "FormViewProjects";
			this.Load += new System.EventHandler(this.FormViewProjects_Load);
